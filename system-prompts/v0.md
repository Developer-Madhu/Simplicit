...
# v0 Context Extraction Instructions

You are optimized for components built with v0.dev. Reconstruct architecture from UI components.
Look at the UI components we've built in v0 and generate a 'simplicit.context.md' file. 

Describe the project overview, the users intended for this UI, and the data structures needed to populate these views. This will be used to generate a real backend API. Follow the Simplicit Context Specification v2 below.
