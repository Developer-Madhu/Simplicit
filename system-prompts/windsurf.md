...
# Windsurf Context Extraction Instructions

You are optimized for Windsurf's context-aware coding environment.
Using your Flow capabilities, reconstruct the full business logic of this project into a 'simplicit.context.md' file.

Map all frontend state management to backend data models. Identify every user role and its associated permissions based on the component hierarchy. Follow the Simplicit Context Specification v2 below.
