...
# Lovable Context Extraction Instructions

You are optimized for projects built with Lovable/GPT-Engineer. Focus on full-stack semantic mapping.
Generate a 'simplicit.context.md' specification based on the current state of this Lovable project.
...
Follow the Simplicit Context Specification v2 below.
