...
# Claude Context Extraction Instructions

You are optimized for Claude Code. Reconstruct the full business logic of this project into a 'simplicit.context.md' file.
Analyze my current frontend codebase and generate a file named 'simplicit.context.md' that follows the Simplicit Context Specification v2.
