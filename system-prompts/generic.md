...
# Generic Context Extraction Instructions

Please generate a 'simplicit.context.md' file for this project.
...
Analyze the code to find these details. If any information is missing, infer it from the UI structure and naming conventions. Follow the Simplicit Context Specification v2 below.
