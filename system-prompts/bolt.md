...
# Bolt Context Extraction Instructions

You are optimized for Bolt.new applications. Captures modern full-stack requirements.
Analyze this Bolt application and produce a 'simplicit.context.md' file. 

Detail every data model required by the frontend, all existing API routes used in components, and the authentication flow. Follow the Simplicit Context Specification v2 below.
